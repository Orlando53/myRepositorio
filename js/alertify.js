    ...
    Alertify = function() {
        ...
        dialogs = {
            buttons: {
                ...
                submit: "<button type=\"submit\" class=\"nvt-btn nvt-btn-success\" id=\"alertify-ok\" />{{ok}}</button>",
                //ok: "<a href=\"#\" class=\"alertify-button alertify-button-ok\" id=\"alertify-ok\">{{ok}}</a>",
                ok: "<a href=\"#\" class=\"nvt-btn nvt-btn-success\" id=\"alertify-ok\">{{ok}}</a>",
                //cancel: "<a href=\"#\" class=\"alertify-button alertify-button-cancel\" id=\"alertify-cancel\">{{cancel}}</a>"
                cancel: "<a href=\"#\" class=\"nvt-btn nvt-btn-danger\" id=\"alertify-cancel\">{{cancel}}</a>",
            },
        ...
        return {
            alert: function(message, fn) {
                _alertify.dialog(message, "alert", fn);
                return this;
            },
            confirm: function(message, fn) {
                _alertify.dialog(message, "confirm", fn);
                return this;
            },
            ...
            prompt: function(message, fn, placeholder) {
                _alertify.dialog(message, "prompt", fn, placeholder);
                return this;
            },
