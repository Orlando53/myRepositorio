 ...
 * @Modificacion:   cambio de extensi�n, inplementat iFrame
 */
@session_start();
 		...
 		<div class="col-xs-6">
 			...
 			<div class="col-xs-4" style="height:100%">
 				<ul class="panel-list jumbo">
 					<div class="jumboson">
		 				<li>
		 					<a href="#" class="panel-button"><span>Organización</span></a>
		 				</li>
		 			...
		 			<div class="jumboson">
		 				<li>
		 					<a href="diagnostico/listaDiagnostico.php" target="iframe_a" class="panel-button"><span>Diagnóstico</span></a>
		 				</li>
